...
public class ExtraMoreAdvancedTurnierManager implements TurnierManager
{
	...
	public Runde starteNaechsteRunde(Turnier turnier) 
	{
		...
		Protokol.write("ExtraMoreAdvancedTurnierManager:startNaechsteRunde:maxrunden:" + maxrunden + ":aktiverunde:" + aktiverunde);
		...
		if (maxrunden-1 > aktiverunde)
		{
			...
			for (int i=0;i<Parameter.maxiter;i++) // Erste Iteration
			{
				...
				{
					s = 0;
					Protokol.write("ExtraMoreAdvancedTurnierManager:Anzahl Iterationen: " + t + " Derzeitiges Minimum Teil1: " + minimum);
				}
			...
			{
				Protokol.write("ExtraMoreAdvancedTurnierManager:Minimum Bewertung Teil1:Es konnte keine Minimum Runde ermittelt werden");
				JOptionPane.showMessageDialog(null,"Es konnte keine Runde ermittelt werden","Fehler",JOptionPane.INFORMATION_MESSAGE);
			}
			else
			{
				Protokol.write("ExtraMoreAdvancedTurnierManager:Minimum Bewertung Teil1: " + minimum);
				minimum = bewerteTeil2(minimumRunde);
				Protokol.write("ExtraMoreAdvancedTurnierManager:Erste Bewertung Teil2: " + minimum);
				/*
				...
				*/
				for (int i=0;i<Parameter.maxiter;i++) 
				{
					...
					{
						s = 0;
						Protokol.write("ExtraMoreAdvancedTurnierManager:Anzahl Iterationen: " + t + " Derzeitiges Minimum Teil2: " + minimum);
					}
				...
				Protokol.write("ExtraMoreAdvancedTurnierManager:Minimum Bewertung Teil2: " + minimum);
				minimum = bewerteTeil3(minimumRunde);
				Protokol.write("ExtraMoreAdvancedTurnierManager:Erste Bewertung Teil3: " + minimum);
				...
				Protokol.write("ExtraMoreAdvancedTurnierManager:Minimum Bewertung Teil3: " + minimum);
			}
		}
		else
		{
	...
	private int bewerteTeil2(Runde runde)
	{
		...
		if (runde != null)
		{
			...
			erg += bewerteDieFarbdifferenzEinesSpielersSollteKleiner2Sein(runde);
			//erg += bewerteGleichGuteSpielerSolltenGegeneinaderSpielen(runde);
			erg += bewerteGleicheFarbeHintereinander(runde);
		}
		return erg;
	}
	...
	private int bewerteGleicheFarbeHintereinander(Runde runde)
	{
		int erg = 0;
		for (int i=0;i<Parameter.auswertungen.size();i++)
		{
